...
dm = dm.loc[:, ['participant_id', 'sex_male', 'sex_female']].set_index('participant_id')
...
m_gt_f = ('male > female', 'T', ['sex_male', 'sex_female'], [1., -1.])
f_gt_m = ('female > male', 'T', ['sex_male', 'sex_female'], [-.1, 1.])
